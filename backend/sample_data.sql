...
('intent1', 'query_electricity_today', 'how much electricity did I use today', 1, 'You used {kwh} kilowatt-hours today, which cost about {cost} dollars.', '["how much electricity did I use today", "what is my electricity usage today", "how much power did I use today"]'),
...
('intent4', 'greenest_time', 'what is the greenest time to use power', 0, 'The greenest time to use electricity is {green_time}.', '["what is the greenest time to use power", "best time to use electricity", "greenest time for power"]'),
('intent5', 'query_co2_saved', 'how much CO2 did I save today', 1, 'You saved {co2} kilograms of CO2 today.', '["how much CO2 did I save today", "carbon dioxide saved", "environmental impact today"]'),
('intent6', 'random_tip', 'give me a sustainability tip', 1, 'Here is a tip: {tip}', '["give me a sustainability tip", "eco tip", "green advice"]'),
...
('intent9', 'compare_community', 'how green am I compared to others', 1, 'You used {compare} electricity than your community average, {diff} kilowatt-hours {compare_text}.', '["how green am I compared to others", "community comparison", "am I greener than others"]'),
('intent10', 'summary_today', 'summarize my green behavior today', 1, 'Today you used {kwh} kilowatt-hours and saved {co2} kilograms of CO2.', '["summarize my green behavior today", "today summary", "daily eco summary"]');
